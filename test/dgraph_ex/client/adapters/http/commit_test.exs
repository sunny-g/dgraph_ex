defmodule DgraphEx.Client.Adapters.HTTP.UnitTest.CommitTest do
  ...
  describe "HTTP.commit/2" do
    ...
    test "should set keys in request body" do
      ...
      expected_body =
        ~s(["AAALX3ByZWRpY2F0ZV8AAAAAAAAAAAI=","AAAHYmFsYW5jZQAAAAAAAAAAAg==","AAALX3ByZWRpY2F0ZV8AAAAAAAAAAAE=","AAAHYmFsYW5jZQAAAAAAAAAAAQ=="])
