defmodule DgraphEx.Core.Query.Block do
  @moduledoc false
  ...
  # [[genres: [%DgraphEx.Core.Query.Block{keywords: [orderdesc: %DgraphEx.Core.Expr.Val{label: :C}], label: :genre}, [genre_name: :name@en]]]]
