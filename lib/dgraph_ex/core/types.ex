defmodule DgraphEx.Core.Types do
  @moduledoc false
  ...
  Examples:
    ...
    iex> DgraphEx.Core.Types.validate(:geo, [[[1.0, 0.1], [1.0, 0.2], [1.1, 0.2], [1.0, 0.1]]])
    :ok

    iex> DgraphEx.Core.Types.validate(:geo, nil)
    {:error, :invalid_geo}
  ...
  Examples:
    ...
    iex> DgraphEx.Core.Types.is_any_of?([:int, :string], "Beef")
    true

    iex> DgraphEx.Core.Types.is_any_of?([:float, :int], "Beef")
    false
